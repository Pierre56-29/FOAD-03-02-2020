...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 10 fév. 2020 à 11:02
...
(42, 'xbsf', 'private', 'Uploads/10.02.20.1694720.png', 'xc', '2020-02-10 10:59:16', 1, NULL);
...
(3, 'jannereau2', '$2y$10$F1A9CNI1rM9gQDC2o03ntu/kThnuB1oKKY3AnGTwyHrJNgVnFgbs6', 'jannereau2@fr.fr'),
(4, 'jannereau', '$2y$10$k..lriy9hccCwTLqKSjoFORoTeJHvFSqPUj/Tnu/1qjbUzM9lu0Ku', 'jerem@d.fr');
...
--
ALTER TABLE `picture`
  MODIFY `idPicture` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
